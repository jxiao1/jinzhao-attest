...
elseif(TEE_TYPE STREQUAL "PHYTIUM")
    file(GLOB GENERATION_PLATFORM_U_SRCS ${GENERATION_SRC_PLATFORM_DIR}/phytium/*.cpp)
endif()
...
file(GLOB_RECURSE VERIFICATION_PLATFORM_PHYTIUM_SRCS ${VERIFICATION_SRC_PLATFORM_DIR}/phytium/*.cpp)
...
set(VERIFICATION_U_SRCS
    ...
    ${VERIFICATION_PLATFORM_PHYTIUM_SRCS}
